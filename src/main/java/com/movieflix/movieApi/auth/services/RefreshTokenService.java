...
import com.movieflix.movieApi.auth.entries.RefreshToken;
import com.movieflix.movieApi.auth.entries.User;
...
public class RefreshTokenService {
    ...
    public RefreshToken createRefreshToken(String username) {
        User user = userRepository.findByEmail(username).orElseThrow(
                () -> new UsernameNotFoundException("User nor found with email: " + username)
        );
